...
import operations.FileManipulator;
...
public class Controller {
	...
	public Account createAccount(){
		...
		if (this.account == null) {
			...
			LocalDate birthday = accountsFile.dateStringToLocalDate(userInfo.get("birthday"));
					
			this.account = new Account(userNumbers.get("balance"),userNumbers.get("withdrawLimit"), 
					userInfo.get("holder"), userInfo.get("CPF"), birthday);
